    ...
    <>
      ...
      >
        ...
        <Stack>
          ...
          <Divider marginY={2} borderColor="whiteAlpha.500" />

          <Stack direction="row" alignItems="center" spacing={3} paddingX={2}>
            <img
              src={user?.imageUrl}
            ...
            />
            <Text fontWeight="medium" color="white" isTruncated>
              {user?.fullName ?? "User"}
            </Text>
          </Stack>
