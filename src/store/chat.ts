...
const initialChatState: Chat[] = getSafeSavedChats() || [
    {
        ...
        content: [
            ...
            {
                emitter: "gpt",
                message: "This website is a Place people can come and gather the requirements of the list of documents they need as to complete the document making process."
            }
        ],
    },
    {
